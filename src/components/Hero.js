...
const Hero = () => {
  ...
  return (
    <section id="hero" className="hero section light-background">
      <img src="/assets/img/portfolio/Skills.PNG" alt="" />

      <div className="container" data-aos="zoom-out">
        <div className="row justify-content-center">
          <div className="col-lg-9">
            <h2>Eric John Kenneth Briones</h2>
            <p>I'm <span className="typed" data-typed-items="Designer, Developer, Freelancer, 3D Art Designer">Designer</span><span className="typed-cursor typed-cursor--blink" aria-hidden="true"></span></p>
